...
export const CrmChallengesForm: React.FC<CrmChallengesFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    toast.success("Request submitted!", {
      description:
        "An email with your details has been sent to dme85928@gmail.com. We will get back to you shortly.",
    });
  ...
  return (
    <form className="space-y-6" onSubmit={handleSubmit}>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        <Input required placeholder="Company" className={inputClasses} />
        <Input placeholder="Address" className={inputClasses} />
        <Input
          required
          type="email"
      ...
      <Button
        variant="primary"
        size="lg"
        className={`w-full !bg-white !text-violet hover:!bg-accent-yellow hover:!text-violet ${lightMode ? "" : "ring-2 ring-white/40 ring-offset-2 ring-offset-violet"}`}
