...
import objectConfigImg from '@/assets/URM/4.3.ObjectConfig.png';
import mergeTypeImg from '@/assets/URM/5.1.MergeTypeScreen.png';

const URM_IMAGE_MAP: Record<string, string> = {
  'urm-admin-settings': adminSettingsImg,
  'urm-object-settings': objectSettingsImg,
  'urm-object-config': objectConfigImg,
  'urm-merge-type': mergeTypeImg,
};
...
export const URM: React.FC = () => {
  ...
  return (
    <div className="pt-14 lg:pt-32">
      <SEOHead
        title="Universal Record Merge User Guide | Klepka"
        description="Universal Record Merge user guide for Salesforce administrators and end users."
        canonicalPath="/urm"
      />
      ...
      <section className="py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[260px_1fr] gap-6 lg:gap-8 items-start">
          <aside className="lg:sticky lg:top-28 bg-card border border-border-color rounded-lg p-4 sm:p-5 shadow-sm">
            ...
            <nav aria-label="URM user guide bookmarks">
