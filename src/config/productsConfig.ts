...
export const comingSoonProducts: ComingSoonProduct[] = [
  {
   ...
   },
   {
     ...
     shortDescription: 'Identify and merge duplicate records across any Salesforce object with a guided workflow that preserves data integrity and improves CRM data quality.',
