...
export const foundersConfig: Founder[] = [
  {
    ...
    title: 'CEO',
    company: 'Klepka',
    shortBio: 'Salesforce architect with 7+ years building scalable CRM solutions for enterprise clients.',
  ...
  },
  {
    ...
    title: 'CTO',
    company: 'Klepka',
    shortBio: 'Senior Salesforce Consultant delivering multi-cloud solutions across Sales, Service, Experience & CRMA.',
